  ...
  <div>
    ...
    <div class="mt-12 spaced-y-10">
      <div v-for="article in articles" :key="article.title">
        <div>
          <nuxt-link :to="'/articles/' + article.slug" class="text-lg font-bold no-underline hover:underline">
            {{ article.title }}
          </nuxt-link>
          ...
          <div class="text-grey-darkest text-base leading-normal mt-2">
            <nuxt-link
              ...
              class="text-gray-darker hover:text-black dark-hover:text-white text-sm no-underline hover:underline"
            >
              Read this article →
            </nuxt-link>
          </div>
