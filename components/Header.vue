<template>
  <div class="relative z-20 flex justify-between items-center">
    <div class="flex md:block lg:flex items-center max-w-full">
      ...
      <div>
        <a href="/" class="block text-black no-underline font-bold text-xl lg:text-3xl font-extrabold leading-none lg:leading-tight">
          Faruk Can</a>
        <div class="hidden md:flex mt-1 lg:mt-2 uppercase tracking-wide text-xs spaced-x-6">
          <span class="text-gray-700 font-semibold">Full-Stack Developer</span>
        </div>
      </div>
    </div>
  </div>
